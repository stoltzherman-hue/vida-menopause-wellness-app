...
const ARTICLES = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'What actually helps?', body: 'Menopause-specific CBT is one non-hormonal option recommended by NICE for vasomotor symptoms. Cooling strategies, breathable clothing and noticing personal triggers may also make episodes easier to manage.\n\nHRT: Hormone replacement therapy is an effective treatment for vasomotor symptoms. Whether it is suitable depends on your symptoms, health history, preferences and individual risk factors, so discuss the benefits and risks with a qualified healthcare professional.\n\nNon-hormonal options: Several prescription treatments are available when HRT is not suitable or preferred. A clinician can help identify an appropriate option.' },
      { heading: 'Night sweats', body: 'Night sweats are hot flushes that occur during sleep. The sleep disruption can add to fatigue, mood changes and difficulty concentrating. A cooler room, breathable bedding and easy access to water may help. If symptoms are persistent or disruptive, ask a healthcare professional about treatment options.' },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: 'What helps?', body: 'Prioritising sleep, regular movement, managing stress, limiting alcohol, and maintaining social and cognitive engagement can support general brain health. Evidence does not support using HRT solely to improve cognition, though treating other menopause symptoms may indirectly help some people feel clearer. If memory or thinking changes are persistent, worsening or worrying, speak to a healthcare professional.' },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Anxiety', body: 'New or worsening anxiety can occur during the menopause transition and may present in different ways, including persistent worry or panic symptoms. Anxiety also has many other possible causes. A healthcare professional can help assess the full picture, especially if symptoms are new, severe or affecting daily life.' },
      { heading: 'What helps', body: 'Treatment depends on the cause and severity of symptoms. NICE recommends considering menopause-specific CBT for depressive symptoms and sleep problems associated with menopause. HRT may help some menopause-related mood symptoms, but suitability and risks are individual. Regular movement, sleep support and professional mental-health care may also form part of a plan.' },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: 'Yoga and mind-body exercise', body: 'Yoga and tai chi can support flexibility, balance, relaxation and general wellbeing. Evidence for directly reducing hot flushes is mixed, so treat them as supportive practices rather than guaranteed symptom treatments.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Know what to ask for', body: 'You can ask to discuss hormonal and non-hormonal treatment options, including the benefits and risks for your health history. If you are not getting the support you need, ask what specialist referral options are available in your healthcare system or seek a second clinical opinion.' },
  ...
  },
  {
    ...
    sections: [
      { heading: 'Is HRT safe?', body: 'For many people with menopause symptoms, the benefits of HRT may outweigh the risks. The balance depends on age, time since menopause, symptoms, medical history, the type of HRT and how it is taken. A qualified healthcare professional should assess this with you rather than applying one rule to everyone.' },
      { heading: 'What are the risks?', body: 'Risk varies by formulation, route, duration and individual health factors. Combined HRT is associated with a small increase in breast-cancer risk, while oral HRT can increase blood-clot risk. Transdermal options may have a different risk profile. Ask your clinician to explain the absolute benefits and risks for your situation.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Treatment options', body: 'Local vaginal oestrogen is one effective option and is available in several forms. Systemic absorption is generally low, but suitability should still be discussed with a clinician, particularly after hormone-sensitive cancer.\n\nNon-hormonal vaginal moisturisers and lubricants can provide symptom relief. A healthcare professional can also discuss other prescription options where appropriate.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'What reduces risk', body: 'Regular movement, not smoking, managing blood pressure and cholesterol, eating well and limiting alcohol can support cardiovascular health. HRT should not be started solely to prevent heart disease; its individual benefits and risks should be discussed with a qualified healthcare professional.' },
    ],
  },
]
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#09070e', fontFamily: 'var(--font-dm-sans), system-ui, sans-serif' }}>
      ...
      <article style={{ maxWidth: 740, margin: '0 auto', padding: 'clamp(40px, 6vw, 72px) 24px clamp(48px, 8vw, 96px)' }}>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.09)', paddingTop: 24, marginTop: 12 }}>
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.32)', marginBottom: 10, textTransform: 'uppercase', letterSpacing: '0.08em' }}>Clinical reference points</p>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px 18px' }}>
            <a href="https://www.who.int/news-room/fact-sheets/detail/menopause" target="_blank" rel="noopener noreferrer" style={{ color: '#9b7cc8', fontSize: 13 }}>WHO menopause overview</a>
            <a href="https://www.nice.org.uk/guidance/ng23/chapter/Recommendations" target="_blank" rel="noopener noreferrer" style={{ color: '#9b7cc8', fontSize: 13 }}>NICE recommendations</a>
            <a href="https://www.nhs.uk/conditions/menopause-and-perimenopause/" target="_blank" rel="noopener noreferrer" style={{ color: '#9b7cc8', fontSize: 13 }}>NHS guidance</a>
            <a href="https://www.acog.org/womens-health/faqs/hormone-therapy-for-menopause" target="_blank" rel="noopener noreferrer" style={{ color: '#9b7cc8', fontSize: 13 }}>ACOG hormone therapy FAQ</a>
          </div>
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.28)', lineHeight: 1.6, marginTop: 12 }}>Reviewed against these public guidance sources in September 2026. Content is educational and is not represented as clinician-reviewed.</p>
        </div>
