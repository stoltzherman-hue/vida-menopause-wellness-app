    ...
    <aside className="app-sidebar">
      ...
      <div style={{ paddingLeft: 8, marginBottom: 40 }}>
        <p style={{
          ...
          fontSize: 30, fontWeight: 700, color: '#1e3d35', margin: 0, lineHeight: 1,
          letterSpacing: '-0.02em',
        }}>
          vida<span style={{ color: '#2d8b7a' }}>.</span>
        </p>
        <p style={{
          fontSize: 10, color: '#8a7a72', marginTop: 5, letterSpacing: '0.06em',
      ...
      {/* Settings */}
      <div style={{ borderTop: '1px solid rgba(61,44,53,0.07)', paddingTop: 12, marginBottom: 12 }}>
      ...
      <div className="sidebar-upgrade">
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{
            ...
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#c9a96e" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
            </svg>
          </div>
          <p style={{ fontWeight: 700, color: 'white', fontSize: 14, margin: '0 0 4px' }}>Upgrade to Premium</p>
          ...
          <Link href="/settings" style={{
            ...
            textDecoration: 'none',
            fontFamily: 'var(--font-dm-sans), system-ui, sans-serif',
            boxShadow: '0 3px 12px rgba(201,169,110,0.30)',
            minHeight: 'unset',
          }}>
            View plans
          </Link>
